...
/* @var $model ZhiCaiWX\models\forsearch\WxEventSubscribeSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default wx-event-subscribe-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new ZhiCaiWX\models\WxEventSubscribe();
