...
?>
<div class="panel panel-default wx-response-keyvalue-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new ZhiCaiWX\models\WxResponseKeyvalue();
...
<script type="text/javascript">
    ...
    function changeStatus(f, v, k) {
        ...
        var url = '<?= Yii::$app->urlManager->createUrl('response-keyvalue/change-status-ajax') ?>';
        $.ajax({
            url: url,
