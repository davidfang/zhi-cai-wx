...
/* @var $model ZhiCaiWX\models\forsearch\WxResponseKeywordSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default wx-response-keyword-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new ZhiCaiWX\models\WxResponseKeyword();
