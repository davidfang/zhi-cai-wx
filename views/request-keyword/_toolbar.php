...
/* @var $model ZhiCaiWX\models\forsearch\WxRequestKeywordSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default wx-request-keyword-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new ZhiCaiWX\models\WxRequestKeyword();
