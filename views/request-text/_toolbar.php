...
/* @var $model ZhiCaiWX\models\forsearch\WxRequestTextSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="panel panel-default wx-request-text-toolbar">批量操作：
    <?php
    $jsfuncton = false;
    $model = new ZhiCaiWX\models\WxRequestText();
